...
export default async function ProductDetail({ params }) {
  ...
  return (
    <div className="details-container w-full max-sm:px-4 sm:w-[80%] flex flex-col lg:flex-row gap-8 mx-auto my-10">
      <img src={product.image} alt={product.title} className="h-auto w-full lg:w-1/2" />
